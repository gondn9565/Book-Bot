...
function Navbar() {
  ...
  return (
    <>
      <div
        className={` max-w-screen-2xl container  md:px-20 px-4   fixed top-0 left-0 right-0 z-50  ${
          sticky
      ...
      >
        <div className="navbar max-w-screen-2xl container mx-auto md:px-20 px-4">
          ...
          <div className="navbar-end space-x-3">
            ...
            <label className="input focus-within:outline-none focus-within:ring-0 focus-within:border-none">
              <svg
